...
flags.DEFINE_string(
    "base_dir", "logs", "Base directory to host all required sub-directories."
)
flags.DEFINE_string(
    "network", "logs", "Base directory to host all required sub-directories."
)
flags.DEFINE_multi_string(
    "gin_files",
    ["configs/general.gin", "configs/ppo.gin"],
...
def set_experiment_identifier(
    ...
    agent_folder = ("-").join(
        [
            ...
            period,
            epoch,
            node_state_size_path,
            message_iterations_path,
        ]
    )
    ...
    experiment_identifier = os.path.join(
...
mode = "training"
episode = 224
experiment_identifier = set_experiment_identifier(
    network,
    env_number,
    create_message_nn,
    generator_slices,
...
dir_check = (
    "checkpoints_historicos/" + experiment_identifier + "/episode" + str(episode)
)
