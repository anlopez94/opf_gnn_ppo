                            ...
                            for hidden_units_message in hidden_units_message_list:
                                for env_type in env_type_list:
                                    for reward_magnitude in reward_magnitude_list:
                                        for reward_computation in reward_computation_list:
                                            for eval_period in eval_period_list:
                                                for last_training_sample in last_training_sample_list:
                                                    for gamma in gamma_list:
                                                        # for epoch in epoch_list:
                                                        for env_number in env_number_list:
                                                                        ...
                                                                        for clip in clip_list:
                                                                            for gae_lambda in gae_lambda_list:
                                                                                cmd = "python ./run.py" \
                                                                                    ...
                                                                                    " --gin_bindings='Environment.reward_computation = \""+reward_computation+"\"'" \
                                                                                    " --gin_bindings='Environment.horizon_percentage = "+str(horizon_percentage)+"'" \
                                                                                    ...
                                                                                    " --gin_bindings='PPOAgent.last_training_sample = "+str(last_training_sample)+"'" \
                                                                                    ...
                                                                                    " --gin_bindings='Actor.hidden_units_readout = \"" + str(actor_hidden_units_readout) + "\"'" \
                                                                                    " --gin_bindings='Actor.hidden_units_update = \"" + str(hidden_units_update) + "\"'" \
                                                                                    " --gin_bindings='Actor.hidden_units_message = \"" + str(hidden_units_message) + "\"'" \
                                                                                    ...
                                                                                    " --gin_bindings='Critic.hidden_units_readout = \"" + str(critic_hidden_units_readout) + "\"'" \
                                                                                    " --gin_bindings='Critic.hidden_units_update = \"" + str(hidden_units_update) + "\"'" \
                                                                                    " --gin_bindings='Critic.hidden_units_message = \"" + str(hidden_units_message) + "\"'" \
                                                                                    ...
                                                                                    " --gin_bindings='Critic.create_message_nn = \"" + str(create_message_nn) + "\"' &"
